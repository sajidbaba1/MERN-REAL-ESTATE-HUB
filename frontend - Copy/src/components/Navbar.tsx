...
const Navbar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribeNotification = webSocketService.onNotification((notif) => {
      console.log('[Navbar] Real-time notification received:', notif);
      // Increment count and refresh lists
