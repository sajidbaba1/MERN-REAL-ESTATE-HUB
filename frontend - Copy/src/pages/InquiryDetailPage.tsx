          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-100">
                <h4 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-3">Document Verification</h4>
                <div className={`p-3 rounded-lg flex items-center justify-between ${inquiry.documentStatus === 'APPROVED' ? 'bg-green-50 text-green-800' :
                  inquiry.documentStatus === 'PENDING' ? 'bg-orange-50 text-orange-800' :
                    inquiry.documentStatus === 'REJECTED' ? 'bg-red-50 text-red-800' :
                      'bg-gray-100 text-gray-800'
                  }`}>
                  <span className="text-sm font-medium">Status: {inquiry.documentStatus || 'NONE'}</span>
                  {inquiry.documentStatus === 'APPROVED' && <CheckCircle className="w-4 h-4" />}
                </div>
                {inquiry.documentUrl && (
                  <a
                    href={(() => {
                      ...
                      return serverBase + (inquiry.documentUrl?.startsWith('/') ? '' : '/') + inquiry.documentUrl;
                    })()}
                    target="_blank"
